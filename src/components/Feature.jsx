  ...
  return (
    <section className="bg-black pb-52">
        <div className="container mx-auto-px-3 md:px-10">
            ...
            where a vibrant array of products converge into an interconncted
            overlay experince on your world 
            </p>
            </div>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bent-tilt_2">
                <div className="flex size-full flex-col justift-between bg-violet-300 p-5">
                    <h1 className='bento-title special-font max-w-64 text-black'>M<b>o</b>re co<b>m</b>ing so<b>o</b>n</h1>
                    <TiLocationArrow className='m-5 scale-[5] self-end'/>
                </div>
            </BentoTilt>
            <BentoTilt className="bento-tilt_2">
                <video src="videos/feature-5.mp4" loop muted autoPlay className='size-full object-center object-cover'></video>
            </BentoTilt>
        </div>
        </div>
    </section>
