  ...
  return (
    <div id="contact" className="my-20 min-h-96 w-screen px-10">
        <div className="relative bg-black py-24 rounded-lg text-blue-50 sm:overflow-hidden">
            <div className="absolute -left-20 top-0 hidden h-full w-72 overflow-hidden sm:block md:left-20 lg:w-96">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <p className="special-font mt-10 w-full font-zentry text-5xl leading-[0.9] md:text-[6rem]">
                    Let's bui<b>l</b>d the <br/> n<b>e</b>w era of <br/> ga<b>m</b>ing t<b>o</b>gether
                </p>
